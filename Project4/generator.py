...
class TrafficGenerator:
    ...
    def generate_routefile(self, seed):
        ...
        with open("intersection/episode_routes.rou.xml", "w") as routes:
            ...
            <route id="N_S_HDV" color="1,0,1" edges="N2TL TL2S"/>
            <vehicle id="HDV" type="standard_car" route="N_S_HDV" depart="1.0" departLane="2" departSpeed="10"/>
            <vehicle id="RL" type="standard_car" route="S_W_RL" depart="1.0" departLane="3" departSpeed="14"/> """, file=routes)
